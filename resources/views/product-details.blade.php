   ...
   <body>
            ...
            <div class="row">
               <div class="col-sm-6 text-center left-section">
                  ...
                  <div class="product_arrow_prev">
                     <span><img data-slide="1" class="img-fluid" src="../images/left caret.png" alt=""></span>
                  </div>
                  <div class="product_arrow_next">
                     <span><img data-slide="2" class="img-fluid" src="../images/right caret.png" alt=""></span>
                  </div>
      ...
      <section class="section-slider">
         ...
         <div class="animal-product">
            <div class="item">
               <div class="product-img"><a href="#"><img class="img-fluid" src="../images/Layer 8.png" alt=""></a></div>
               <div class="title">
