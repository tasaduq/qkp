...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('pageTitle') - Qurbani Kiston Pay</title>
        <meta name="description" content="Qurbani Ab Sab Ki Pohanch Main, Sood Say Pak.. Ain Shariah Kay Mutabiq">
         ...
         <!-- Global site tag (gtag.js) - Google Analytics -->
         <script async src="https://www.googletagmanager.com/gtag/js?id=G-HZBMZMXSKS"></script>
         <script>
         window.dataLayer = window.dataLayer || [];
         function gtag(){dataLayer.push(arguments);}
         gtag('js', new Date());

         gtag('config', 'G-HZBMZMXSKS');
         </script>
         ...
         <script>
            ...
            fbq('init', '265544738500251');
            fbq('track', 'PageView');
            </script>
            <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=265544738500251&ev=PageView&noscript=1"
            /></noscript>
                ...
                {{-- <form action="/examples/actions/confirmation.php" method="post"> --}}
                  @csrf 
                    ...
                    <div class="row social">
                        <div class="col-sm-6">
                            <a id="fb-login-btn" href="{{url('/slogin/facebook')}}" class="btn facebook" type="button"><i class="fab fa-facebook-f"></i> Facebook</a>
                        </div>
                        <div class="col-sm-6">
                            <a id="fb-login-btn" href="{{url('/slogin/google')}}" class="btn google" type="button"><i class="fab fa-google"></i> Google</a>
                        </div>
                    </div>
