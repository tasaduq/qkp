      ...
      <div class="row about-us-content">
          <div class="col-sm-12 order-sm-6 order-2">
              ...
              <ul class="pl-4 text-justify">
                ...
                <li class="mb-3">If the customer chooses to cancel the booking of their animal after the 7-Day period QKP shall deduct 30% of the <strong>total</strong> paid amount till date by the customer. The customer will receive their amount post deduction within 30 working days.</li>
                ...
                <li class="mb-3">If the customer fails to pay two consecutive installments, the order will automatically be cancelled. A 30% deduction shall be made on the <strong>total</strong> paid amount by the customer and shall be refunded within 30 working days.</li>
                <li>Once the animal has been booked, it cannot be exchanged with another animal.</li>
             </ul>
          </div>
      </div>
  </div>
